      ...
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2 text-white font-louis-george-cafe">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <a 
                    href="https://www.google.com/maps/search/?api=1&query=L2-29%2630%2C%20The%20Link%202%2C%20Jalan%20Jalil%20Perkasa%203%2C%20Bukit%20Jalil%2C%2057000%2C%20Bukit%20Jalil%2C%20Kuala%20Lumpur"
                    target="_blank"
        ...
        <div className="flex justify-center md:justify-start mt-8 md:mt-0">
          <div>
            <h4 className="text-lg font-semibold mb-4 font-louis-george-cafe uppercase tracking-wide gradient-highlight-white text-center md:text-left">Follow Us</h4>
